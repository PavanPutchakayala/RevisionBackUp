...
public class BaseTest {
	...
	public void beforeTest(ITestContext context)
		...
		// JSONObject data = new DataUtil().getTestData(datafilpath, dataFlag,
		// Integer.parseInt(iteration));
		JSONObject data = new ReadingXLS().getTestData(sheetName, dataFlag, (Integer.parseInt(iteration) + 1),
				datafilpath);
